...
os.chdir('D:\\multiens\\dataset\\Independent_test')#修改当前工作目录路径
...
data_=sio.loadmat(r'Mix_Ecoli_data.mat')
data=data_.get('protein_B')
fastas=[]
...
sio.savemat('Ec_CT_b.mat',{'Ec_CT_b':CTtriad3})
