...
os.chdir('C:\\Users\\Personal\\Desktop\\multiens\dataset\\H.pylori')#修改当前工作目录路径
...
data_=sio.loadmat(r'Matine_Data.mat')
data=data_.get('N_protein_a')
fastas=[]
...
sio.savemat('H_CT_Na.mat',{'H_CT_Na':CTtriad3})
